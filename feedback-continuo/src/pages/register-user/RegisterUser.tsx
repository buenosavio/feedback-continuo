...
const RegisterUser = () => {
  ...
  const [baseImage, setBaseImage] = useState<any>(defaultImage);
  ...
  return(
    ...
    <ContainerLogin>
      ...
      <Form onSubmit={formikProps.handleSubmit}>
       <TitleForm htmlFor="profileImage">Insira sua foto</TitleForm>
        <GlobalInput 
        type="file" id="profileImage" name="profileImage"
          onChange={(event:any) => {uploadImage(event)}}
        />
        <br></br>
        <Image src={baseImage} width="80px" height="80px" />
        
        <TitleForm htmlFor="name">Nome Completo</TitleForm>
        <GlobalInput id="name" name="name" type="text"
        ...
        <GlobalInput id="email" name="email" type="text"
          onChange={formikProps.handleChange}
        ...
        <GlobalInput id="password" name="password" type="password"
          onChange={formikProps.handleChange}
        ...
        <GlobalInput id="confirm_password" name="confirm_password" type="password"
          onChange={formikProps.handleChange}
