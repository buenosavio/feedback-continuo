      ...
      <Tab title="Recebidos">
        ...
        {received ? received.map ((feedback:GivedFeedbackDTO) =>(
          <div key={feedback.feedbackId}>
              <Card  profileUserImage={feedback.profileUserImage ? `data:image/png;base64,${feedback.profileUserImage}` : defaultImage}userName={FirstLetterUppercase(feedback.userName)} message={feedback.message} tags={formatTags(feedback.tags)} createdAt={feedback.createdAt}/>  
            </div>
