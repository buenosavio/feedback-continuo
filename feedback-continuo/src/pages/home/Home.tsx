...
const Home = () => {
  ...
  const [btnDisabledReceivedPrevious, setBtnDisabledReceivedPrevious] = useState<boolean>(false);
  const [btnDisabledGivedPrevious, setBtnDisabledGivedPrevious] = useState<boolean>(false);
